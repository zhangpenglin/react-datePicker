	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_datePicker2.default, { onSelected: this.handleSelected.bind(this), oneDay: false })
	            );
	        }
	    }]);
...
/***/ function(module, exports) {
	...
	function ascSort(index) {
	    return { type: 'ASC_SORT', index: index };
	}
	function descSort(index) {
	    return { type: 'DESC_SORT', index: index };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _datePickerInput = __webpack_require__(202);
	...
	var DatePickerClass = function () {
	    function DatePickerClass(year, month) {
	    ...
	    _createClass(DatePickerClass, [{
	        ...
	        value: function chunk() {
	            var chunked = [[], [], [], [], [], []];
	            var chunkIndex = 0;
	            this.days.forEach(function (x, i, c) {
	...
	var DatePicker = function (_Component) {
	    ...
	    _createClass(DatePicker, [{
	        key: 'getDayClass',
	        value: function getDayClass(n) {
	            var d = n.getDay();
	            if (!this.props.oneDay) {
	                //端点样式
	                var sd = this.state.selectedDay;
	                if (sd.indexOf(n) > -1) {
	                    return 'startOrEnd';
	                }
	        ...
	        value: function handleSelectedDay(n, e) {
	            ...
	            if (this.props.oneDay) {
	                ...
	                var a = sd.push(n).sort(function (x, y) {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'date' },
	                    _react2.default.createElement(_datePickerInput2.default, { type: 'text', onFocus: this.handleFocus.bind(this),
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'header' },
	                        _react2.default.createElement('div', { className: 'triangle-left', onClick: this.handlePrev.bind(this) }),
	                        _react2.default.createElement('div', { className: 'triangle-right', onClick: this.handleNext.bind(this) }),
	                            ...
	                            dp.days.map(function (x) {
	                                return _react2.default.createElement(
	                                    ...
	                                    x.map(function (n) {
	                                        return _react2.default.createElement(
	                                            'td',
	                                            { className: _this2.getDayClass(n),
	                                                onClick: _this2.handleSelectedDay.bind(_this2, n) },
	                                            n.getDate()
	                                        );
	                                    })
	                                );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DatePickerInput = function (_Component) {
	    ...
	    function DatePickerInput(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DatePickerInput).call(this, props));
	    ...
	    _createClass(DatePickerInput, [{
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('input', { type: 'text', onFocus: this.handleFocus.bind(this), value: this.state.inputValue, onChange: this.handleChange.bind(this) });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialState = Immutable.fromJS({
	    head: [{ title: '姓名', sort: false }, { title: '语文', sort: true }, { title: '数学', sort: true }, { title: '英语', sort: true }, { title: '总分', sort: true }],
	    body: [['小明', 80, 90, 70, 240], ['小红', 90, 60, 90, 240], ['小红', 90, 60, 90, 240], ['小红', 90, 60, 90, 240], ['小红', 90, 60, 90, 240], ['小红', 90, 60, 90, 240], ['小红', 90, 60, 90, 240], ['小红', 90, 60, 90, 240], ['小红', 90, 60, 90, 240], ['小红', 90, 60, 90, 240], ['小红', 90, 60, 90, 240], ['小红', 90, 60, 90, 240], ['小亮', 60, 100, 70, 230]]
	});
	function sort() {
	    ...
	    switch (action.type) {
	        case 'ASC_SORT':
	            i = action.index;
	            return state.set('body', state.get('body').sort(function (a, b) {
	...
	exports.default = (0, _redux.combineReducers)({ sort: sort });
